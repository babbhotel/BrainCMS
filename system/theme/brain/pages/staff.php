...
<div class="center">
	<div style="width: 600px;"class="columleft">
		...
		<?php
			$getRanks = DB::Query("SELECT id,name,badgeid FROM ranks WHERE id in (9,8,7,6,5,4)  ORDER BY id DESC");
			...
			{	
				...
				';
				$getMembers = DB::Query("SELECT id,username,motto,look,online FROM users WHERE rank = '" . DB::Escape($Ranks['id']) . "'");
				echo '';
