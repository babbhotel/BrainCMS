<html>
	...
	<body>
		...
		<html lang="en">
			...
			<script type="text/javascript">function siteUrl() {return "";}function showReg() {window.location = siteUrl() + "register";}  function fblogin() {window.location = siteUrl() + "/system/fblogin/fbconfig.php";}</script>
		</head>
		<body>
            <div id="site">
				<div id="body">
					<link rel="stylesheet" href="/system/theme/brain/style/css/index/style.css?v=3">
