...
<html lang="en">
	<head>
		<script src="/system/content/theme/brain/style/js/index/index.js?v=4"></script>
		<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Ubuntu:regular,bold&subset=Latin">
		<link rel="stylesheet" href="/system/content/theme/brain/style/css/main2.css?v=<?= $config['hash'] ?>" type="text/css">
		<link rel="stylesheet" href="/system/content/theme/brain/style/css/home.css?v=<?= $config['hash'] ?>" type="text/css">
	</head>
	<style>
	...
	<body background="/system/content/theme/brain/style/images/headerbg/background2016.png">
