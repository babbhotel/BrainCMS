<html>
	...
	<body>
		<!DOCTYPE>
		<html lang="en">
			<link rel="stylesheet" href="/system/content/theme/brain/style/css/index/animate1.css" type="text/css">
			<script type="text/javascript">function siteUrl() {return "";}function showReg() {window.location = siteUrl() + "register";}  function fblogin() {window.location = siteUrl() + "/system/app/fblogin/fbconfig.php";}</script>
		</head>
		<body>
            <div id="site">
				<div id="body">
					<link rel="stylesheet" href="/system/content/theme/brain/style/css/index/style.css?v=4">
					<link rel="stylesheet" href="/system/content/theme/brain/style/css/index/StyleIndex.css?v=4">
					<style type="text/css">
					...
					<header style="background-position-x: -4607px;">
						<div id="main">
							...
							<div id="main" class="pcon">
								...
								<div id="recorder-container-box" style="background-image: url(/system/content/theme/brain/style/images/login/spielbox-bg.png)">
									<div class="text">
										<div class="animated bounceIn">
											<b>
								...
								<div id="recorder-container-box" style="background-image: url(/system/content/theme/brain/style/images/login/eventbox-bg.png); margin-left: 19px;">
									<div class="text">
										<div class="animated bounceIn">
											<b>
								...
								<div id="recorder-container-box" style="background-image: url(/system/content/theme/brain/style/images/login/updatebox-bg.png); float: right; margin-right: 0px;">
									<div class="text">
										<div class="animated bounceIn">
											<b>
