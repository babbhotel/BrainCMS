<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/system/content/theme/brain/style/css/main2.css?v=5" type="text/css">
		<link rel="stylesheet" href="/system/content/theme/brain/style/css/home.css" type="text/css">
	</head>
			...
			<div class="center">
				<a href="#">
					...
					<?php
						...
						{
							echo'	
							<div class="langbox"><a href="/adminpan/dash"><img src="/system/content/theme/brain/style/images/menuicons/settings_icon.png" style="padding:7px;float:right;"> </div>
							';
						}
					?>
				</div>
