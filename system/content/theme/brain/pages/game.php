...
<head>
	...
	<script src="/system/content/theme/brain/client/js/jquery-latest.js" type="text/javascript"></script>
	<script src="/system/content/theme/brain/client/js/jquery-ui.js" type="text/javascript"></script>
	<script src="/system/content/theme/brain/client/js/flashclient.js"></script>
	<script src="/system/content/theme/brain/client/js/flash_detect_min.js"></script>
	<script src="/system/content/theme/brain/client/js/client.js" type="text/javascript"></script>
</head>
<body>
	<center>
		<div id="client-ui">
