...
<div class="center">
	<div class="columleft">
		<div class="boxuser">
			<div class="userplate">
				<img src="/system/content/theme/brain/style/images/icons/online/<?= User::userData('online') ?>.png" style="float:left;padding: 5px;">
			...
			<div class="userstatsbox">
				<div style="color: #f8ef2b; background-image: url(/system/content/theme/brain/style/images/icons/crediticon.png);" class="userstats ">
					<?= User::userData('credits') ?> <?= $lang["Mcredits"] ?>
				</div>
			</div>
			<div class="userstatsbox">
				<div style="color: #e99bdc; background-image: url(/system/content/theme/brain/style/images/icons/duckicon.png);" class="userstats">
					<?= User::userData('activity_points') ?> <?= $lang["Mduckets"] ?>
				</div>
			</div>
			<div style="margin-bottom: 0px;" class="userstatsbox">
				<div style="color: #6caff4; background-image: url(/system/content/theme/brain/style/images/icons/diaicon.png);" class="userstats">
